 ...
 * This class extends the {@link BasicSessionsParam} class to include the number of gestures.
 */
public class ActiveLivenessSessionsParam extends BasicSessionsParam {
